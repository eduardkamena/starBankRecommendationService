...
public class RecommendationsRepositoryTest {
    ...
    public void testGetTransactionAmount_ShouldReturnAmount() {
        ...
        int result = recommendationsRepository.getTransactionAmount(userId, productsType, transactionType);
    ...
    public void testIsProductExists_ShouldReturnTrue() {
        ...
        boolean result = recommendationsRepository.isProductExists(userId, productsType);
    ...
    public void testIsUserExists_ShouldReturnTrue() {
        ...
        when(jdbcTemplate.queryForObject(anyString(), eq(Integer.class), any(UUID.class)))
                .thenReturn(1);
        boolean result = recommendationsRepository.isUserExists(userId);
        assertTrue(result);
    }
